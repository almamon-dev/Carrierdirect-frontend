    ...
    >
      ...
      <div className="mt-8 flex items-center gap-3 w-full">
        ...
        <button
          onClick={onDelete}
          disabled={isLoading}
          className="flex-1 px-4 py-2.5 rounded-md font-semibold text-[14px] text-white bg-red-600 hover:bg-red-700 transition-colors disabled:opacity-50 flex items-center justify-center"
        >
          {isLoading ? (
