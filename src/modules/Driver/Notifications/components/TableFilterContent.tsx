/**
 * Driver TableFilterContent Component
 * Provides filter dropdowns for Driver Category, Read Status, and Type.
 */
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 p-3 bg-slate-50 dark:bg-[#181d24] rounded-[3px] border border-slate-200/80 dark:border-slate-800 mb-3">
            <div>
                ...
                <Select value={categoryFilter} onChange={(e) => setCategoryFilter(e.target.value)} showSearch={false}>
                    ...
                    <option value="order">Loads & Trips</option>
                    <option value="message">Dispatch Messages</option>
                    <option value="finance">Payouts & Settlement</option>
                    <option value="system">Safety & System Alerts</option>
                </Select>
            </div>
            <div>
