/**
 * Driver FilterTabs Component (Ultra-Compact)
...
export type DriverNotificationFilterTab = 'all' | 'unread' | 'order' | 'message' | 'finance' | 'system';

interface FilterTabsProps {
    notifications: HeaderNotification[];
    activeTab: DriverNotificationFilterTab;
    onSelectTab: (tab: DriverNotificationFilterTab) => void;
}
...
export const FilterTabs: React.FC<FilterTabsProps> = ({
    ...
    const tabs = useMemo(() => {
        ...
        return [
            { id: 'all' as DriverNotificationFilterTab, label: 'All', count: counts.all },
            { id: 'unread' as DriverNotificationFilterTab, label: 'Unread', count: counts.unread },
            { id: 'order' as DriverNotificationFilterTab, label: 'Loads & Trips', count: counts.order },
            { id: 'message' as DriverNotificationFilterTab, label: 'Messages', count: counts.message },
            { id: 'finance' as DriverNotificationFilterTab, label: 'Payouts', count: counts.finance },
            { id: 'system' as DriverNotificationFilterTab, label: 'Safety & System', count: counts.system },
