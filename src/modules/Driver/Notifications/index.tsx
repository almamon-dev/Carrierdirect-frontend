/**
 * Driver Notifications Main Page (Ultra-Compact)
 * Designed to strictly match the compact layout standards,
...
export default function DriverNotificationsPage() {
    ...
    const [activeTab, setActiveTab] = useState<DriverNotificationFilterTab>('all');
    ...
    return (
        <div className="p-3 sm:p-4 md:p-5 w-full mx-auto space-y-3.5 min-h-screen font-sans antialiased bg-[#f8fafc] dark:bg-[#12161c]">
            {/* Header Title & Action Buttons (Compact) */}
                ...
                emptyState={
                    <EmptyState
                        ...
                        description={activeTab === 'all'
                            ? "You are completely up to date. New load assignments, messages, and payout updates will appear here."
                            : `No notifications currently match the '${activeTab}' filter.`
                        }
                        actionLabel="View Assigned Shipments"
                        onAction={() => navigate('/driver/shipments')}
                    />
                }
            />
