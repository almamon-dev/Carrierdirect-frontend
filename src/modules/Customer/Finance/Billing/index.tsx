    ...
    return (
        <div className="p-3 md:p-4 mx-auto min-h-screen">
            ...
            <div className="mb-4 flex flex-col md:flex-row md:items-center justify-between gap-3">
                <div>
                    <h1 className="text-[18px] font-bold text-slate-900 leading-tight">Billing & Subscription</h1>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-3 xl:gap-4">
                ...
                <div className="xl:col-span-8 flex flex-col gap-3 xl:gap-4">
                    ...
                    <div className="bg-white rounded-lg border border-slate-200 p-3.5 lg:p-4 shadow-sm">
                        <div className="flex items-center justify-between mb-3 pb-2 border-b border-slate-100">
                            <h2 className="text-[12.5px] font-bold text-slate-900  tracking-wide">Active Plan Details</h2>
                            <Button variant="outline" size="sm" className="h-6 px-2 text-[10.5px] font-bold text-indigo-600 border-indigo-200 hover:bg-indigo-50">
                                Upgrade Plan
                            </Button>
                        </div>

                        <div className="flex items-start gap-3">
                            <div className="w-10 h-10 bg-indigo-50 text-indigo-600 rounded-lg flex items-center justify-center font-black shrink-0 border border-indigo-100">
                                <Package size={20} />
                            </div>
                            <div className="flex-1 w-full">
                                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-1">
                                    <h3 className="text-[14px] font-bold text-slate-900">Enterprise Shipper</h3>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-2 gap-x-4">
                                    <div className="flex items-center gap-1.5 text-[11.5px] font-medium text-slate-700">
                                        <Check size={12} className="text-indigo-600 shrink-0" /> Unlimited order tracking
                                    </div>
                                    <div className="flex items-center gap-1.5 text-[11.5px] font-medium text-slate-700">
                                        <Check size={12} className="text-indigo-600 shrink-0" /> Dedicated account manager
                                    </div>
                                    <div className="flex items-center gap-1.5 text-[11.5px] font-medium text-slate-700">
                                        <Check size={12} className="text-indigo-600 shrink-0" /> Priority 24/7 customer support
                                    </div>
                                    <div className="flex items-center gap-1.5 text-[11.5px] font-medium text-slate-700">
                                        <Check size={12} className="text-indigo-600 shrink-0" /> Advanced analytics dashboard
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 xl:gap-4 flex-1">
                        ...
                        <div className="bg-white rounded-lg border border-slate-200 p-3.5 lg:p-4 shadow-sm flex flex-col">
                            <div className="flex items-center justify-between mb-3 pb-2 border-b border-slate-100">
                                <div className="flex items-center gap-1.5 text-indigo-700">
                                    <CreditCard size={14} />
                                    <h2 className="text-[12.5px] font-bold text-slate-900  tracking-wide">Payment Method</h2>
                                </div>
                                <button className="text-[10.5px] font-bold text-indigo-600 hover:underline ">Edit</button>
                            </div>
                        ...
                        <div className="bg-white rounded-lg border border-slate-200 p-3.5 lg:p-4 shadow-sm flex flex-col">
                            <div className="flex items-center justify-between mb-3 pb-2 border-b border-slate-100">
                                <div className="flex items-center gap-1.5 text-indigo-700">
                                    <Building size={14} />
                                    <h2 className="text-[12.5px] font-bold text-slate-900  tracking-wide">Billing Profile</h2>
                                </div>
                                <button className="text-[10.5px] font-bold text-indigo-600 hover:underline ">Edit</button>
                            </div>
                ...
                <div className="xl:col-span-4 flex flex-col gap-3 xl:gap-4">
                    ...
                    <div className="bg-white p-3.5 lg:p-4 rounded-lg border border-slate-200 shadow-sm relative overflow-hidden">
                        ...
                        <h2 className="text-[12.5px] font-bold text-slate-900 mb-2 pb-2 border-b border-slate-100 tracking-wide relative z-10">Outstanding Balance</h2>
                    ...
                    <div className="bg-white p-3.5 lg:p-4 rounded-lg border border-slate-200 shadow-sm flex-1 flex flex-col">
                        <h2 className="text-[12.5px] font-bold text-slate-900 mb-3 pb-2 border-b border-slate-100  tracking-wide">Next Billing Cycle</h2>
            ...
            <div className="mt-3 xl:mt-4">
                <div className="bg-white p-3.5 lg:p-4 rounded-lg border border-slate-200 shadow-sm overflow-x-auto">
                    <div className="flex items-center justify-between mb-4 pb-2 border-b border-slate-100 min-w-[700px]">
                        <h2 className="text-[12.5px] font-bold text-slate-900  tracking-wide flex items-center gap-1.5">
                            <Receipt size={14} className="text-indigo-600" /> Recent Billing History
                        </h2>
                        <button className="text-[10.5px] font-bold text-indigo-600 hover:underline ">View All Invoices</button>
                    </div>
                            ...
                            {[
                                ...
                                <div key={i} className="flex items-center gap-4 p-2 border-b border-slate-50 last:border-0 hover:bg-slate-50 transition-colors rounded-md">
                                    <div className="w-20 shrink-0">
                                        <span className="text-[11.5px] font-bold text-indigo-600 block">{item.id}</span>
                                    </div>
                                    <div className="w-20 shrink-0">
                                    ...
                                    <div className="w-8 flex justify-end shrink-0">
                                        <button className="text-slate-400 hover:text-indigo-600 bg-white border border-slate-200 shadow-sm p-1 rounded hover:bg-slate-50"><Download size={13} /></button>
                                    </div>
                                </div>
                            ))}
                        </div>
