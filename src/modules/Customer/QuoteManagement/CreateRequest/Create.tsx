        ...
        <div className="p-6 md:p-8 mx-auto bg-[#f8f9fa] min-h-screen pb-24">
            ...
            <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-3">
                    <div>
                        <h1 className="text-[18px] font-bold text-slate-900">Create Quote Request</h1>
                        <p className="text-[14px] font-medium text-brand mt-1">Fill in the required information to submit a request.</p>
                    </div>
                </div>
                <div className="flex items-center gap-3">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
                                    ...
                                    <div className="col-span-1 md:col-span-2 grid grid-cols-1 md:grid-cols-[1fr_1.5fr] gap-6 mt-2 pt-4 border-t border-slate-100">
                                        ...
                                        <div>
                                            ...
                                            <div className="grid grid-cols-2 gap-y-2.5 gap-x-4 bg-slate-50 p-3 rounded-sm border border-slate-200">
                                        ...
                                        <div>
                                            ...
                                            <div className="grid grid-cols-2 lg:grid-cols-3 gap-y-2.5 gap-x-4 bg-slate-50 p-3 rounded-sm border border-slate-200">
                                ...
                                <div className="grid grid-cols-1 gap-y-4">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-2 pt-2">
                                        ...
                                        <div>
                                            ...
                                            <div className="grid grid-cols-1 gap-y-4 bg-slate-50 p-4 rounded-sm border border-slate-200">
                                                <div>
                                        ...
                                        <div>
                                            ...
                                            <div className="flex flex-col gap-y-3.5 bg-slate-50 p-4 rounded-sm border border-slate-200 h-[calc(100%-28px)]">
