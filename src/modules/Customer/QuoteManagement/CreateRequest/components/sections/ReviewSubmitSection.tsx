        ...
        <div className="space-y-4 animate-in fade-in duration-300">
            ...
            <div className="bg-slate-50/80 border border-slate-200 rounded-md p-4 space-y-3.5 text-xs">
                ...
                <div className="flex items-center justify-between border-b border-slate-200 pb-3">
                    <div>
                        ...
                        <div className="flex items-center gap-2 text-slate-500 font-medium text-[11px] mt-1">
                            <span>Priority: <strong className="text-red-600 font-bold">{formData.priority || '-'}</strong></span>
                            <span>•</span>
                            <span>Type: <strong className="text-slate-700">{formData.shipmentType || '-'}</strong> ({formData.serviceType || '-'})</span>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div className="p-3 bg-white border border-slate-200 rounded-md shadow-2xs">
                        ...
                        <p className="font-bold text-slate-900 text-[13px]">{pickupLocation || '-'}</p>
                    ...
                    <div className="p-3 bg-white border border-slate-200 rounded-md shadow-2xs">
                        ...
                        <p className="font-bold text-slate-900 text-[13px]">{deliveryLocation || '-'}</p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 p-3 bg-white border border-slate-200 rounded-md shadow-2xs">
                    <div>
                        ...
                        <span className="font-bold text-slate-900 text-[12px]">{formData.vehicleType || '-'}</span>
                    </div>
                    <div>
            ...
            <div className="pt-2 flex justify-end gap-3">
                <Button
                    ...
                    variant="outline"
                    size="sm"
                    className="h-10 px-5 border-slate-300 text-slate-700 font-bold text-xs flex items-center gap-2 cursor-pointer hover:bg-slate-50"
