...
export const PdfImportWizardModal: React.FC<PdfImportWizardModalProps> = ({
    ...
    return createPortal(
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-xs z-[99999] flex items-center justify-center p-4">
            <div className="bg-white rounded-md shadow-2xl border border-slate-200/80 w-full max-w-4xl overflow-hidden animate-in fade-in zoom-in-95 duration-150 font-sans">
                    ...
                    {[
                        ...
                        return (
                            <button
                                ...
                                className={`flex items-center gap-2 py-1.5 px-3.5 rounded-lg cursor-pointer whitespace-nowrap transition-colors text-xs ${isActive
                            ...
                            >
                                <span className={`w-5 h-5 rounded-full flex items-center justify-center text-xs font-bold ${isActive ? 'bg-[#ff4a1f] text-white' : isPassed ? 'bg-emerald-600 text-white' : 'bg-slate-200 text-slate-600'
                                    }`}>
                                    {isPassed ? '✓' : st.num}
                                </span>
                                <span>{st.label}</span>
                                ...
                                {[
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`flex items-center gap-1.5 px-3 py-1.5 rounded text-xs font-bold transition-colors cursor-pointer whitespace-nowrap ${isActive
