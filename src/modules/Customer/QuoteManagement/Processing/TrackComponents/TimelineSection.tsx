...
export default function TimelineSection({ timeline }: { timeline: any[] }) {
    return (
        <div className="bg-white border border-slate-200 rounded-xl shadow-2xs flex-1 flex flex-col font-sans">
                                ...
                                <div className="flex-1 pb-1">
                                    <div className="flex items-center justify-between">
                                        <h4 className={`text-xs font-bold ${
                                            step.active ? 'text-[#ff4a1f]' : step.completed ? 'text-slate-900' : 'text-slate-400'
                                        }`}>
                                            {step.status}
                                        </h4>
