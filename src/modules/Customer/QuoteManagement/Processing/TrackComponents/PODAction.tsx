...
export default function PODAction({ isPodAccepted, setIsPodAccepted }: { isPodAccepted: boolean, setIsPodAccepted: (v: boolean) => void }) {
    if (isPodAccepted) {
        return (
            <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4 flex items-center gap-3 shadow-2xs font-sans">
    ...
    return (
        <div className="bg-amber-50/80 border border-amber-200 rounded-xl p-4 flex flex-col gap-3 shadow-2xs font-sans">
