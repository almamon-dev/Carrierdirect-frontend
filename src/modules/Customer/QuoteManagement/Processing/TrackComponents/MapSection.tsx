                        ...
                        <div className="relative flex justify-center items-center">
                            ...
                            <div className={`flex flex-col items-center absolute ${index % 2 === 0 ? 'bottom-full mb-2' : 'top-full mt-2'}`}>
                                <div className={`px-2 py-0.5 rounded shadow-sm border text-[9px] font-bold whitespace-nowrap ${
                                    step.active ? 'bg-indigo-600 text-white border-indigo-700' : 
                            ...
                            <div className={`w-3 h-3 rounded-full border-2 border-white shadow-sm z-10 ${
                                step.completed ? 'bg-emerald-500' : step.active ? 'bg-indigo-600 ring-4 ring-indigo-200' : 'bg-slate-300'
                            }`}></div>
                            
                            {/* Truck Icon on Active step */}
                            {step.active && (
                                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white p-1.5 rounded-full shadow-md border-2 border-indigo-600 text-indigo-600 z-20">
                                    <Truck size={14} />
                                </div>
                            )}
                        </div>
