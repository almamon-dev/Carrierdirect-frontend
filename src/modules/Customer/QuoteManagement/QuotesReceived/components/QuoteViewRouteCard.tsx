...
export const QuoteViewRouteCard: React.FC<QuoteViewRouteCardProps> = ({ quote, requestDetail }) => {
    ...
    return (
        <div className="space-y-6">
            <div
    className="bg-white dark:bg-[#1e2329] border border-slate-200 dark:border-slate-800 rounded-lg p-5 shadow-2xs">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div
    className="p-3.5 bg-slate-50 dark:bg-[#161a20] rounded-lg border border-slate-100 dark:border-slate-800/80">
    ...
    className="bg-white dark:bg-[#1e2329] border border-slate-200 dark:border-slate-800 rounded-lg p-5 shadow-2xs">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs">
                    <div
    className="p-3 bg-slate-50 dark:bg-[#161a20] rounded-lg border border-slate-100 dark:border-slate-800">
