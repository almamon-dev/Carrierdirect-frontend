/**
 * Customer Negotiation Row Actions Menu
 * Matches Supplier NegotiationRowActions style with single 3-dots dropdown menu using React Portal and 1-click Chat button.
 */
