...
export const CustomerChatTypingIndicator: React.FC<CustomerChatTypingIndicatorProps> = ({
    ...
    return (
        <div className="flex gap-2.5 justify-start mt-3 mb-3 items-center animate-in fade-in slide-in-from-bottom-2 duration-200">
            <div className="w-8 h-8 rounded-full overflow-hidden bg-orange-50 dark:bg-orange-950/40 border border-orange-200/80 dark:border-orange-900/50 flex items-center justify-center text-[#FF4A1F] font-bold text-xs shrink-0 shadow-2xs">
