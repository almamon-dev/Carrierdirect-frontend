...
export const CustomerChatDetailsPanel: React.FC<CustomerChatDetailsPanelProps> = ({ activeChat, currentMessages = [] }) => {
    ...
    return (
        <div className="hidden xl:flex xl:col-span-3 flex-col min-h-0 h-full bg-white dark:bg-[#12161c] overflow-y-auto border-l border-slate-200 dark:border-slate-800 [&::-webkit-scrollbar]:hidden">
            <div className="flex flex-col items-center pt-8 pb-4">
                <div className="w-16 h-16 shrink-0 aspect-square rounded-full bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-200 border border-slate-200/80 dark:border-slate-700 flex items-center justify-center font-bold text-2xl mb-3 relative shadow-2xs">
                    {activeChat.avatar}
                ...
                <div className="flex items-center gap-1 justify-center">
                    <h3 className="text-[14px] font-bold text-slate-800 dark:text-slate-100">{activeChat.name}</h3>
                ...
                <div className="flex items-center gap-6 mt-4">
                    <div className="flex flex-col items-center gap-1 cursor-pointer group">
                        ...
                        <span className="text-[10px] font-semibold text-slate-600 dark:text-slate-400">Profile</span>
                    </div>
