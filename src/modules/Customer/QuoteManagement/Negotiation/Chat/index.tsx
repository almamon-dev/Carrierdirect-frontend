...
export default function NegotiationChat() {
    ...
    const [chats, setChats] = useState([
        { id: 1, name: 'Prime Movers', avatar: 'P', preview: 'Submitted counter offer € 40,000', time: '10:30 AM', unreadCount: 2, unread: true, active: true, quoteNo: 'QT-8822', baseFreight: '€ 40,000', isVerified: true, isPinned: true },
        { id: 2, name: 'Fast Track BD', avatar: 'F', preview: 'We can do it for 32,000 €.', time: 'Yesterday', unreadCount: 0, unread: false, active: false, quoteNo: 'QT-8823', baseFreight: '€ 32,000', isVerified: true, isPinned: false },
        { id: 3, name: 'Safe Logistics', avatar: 'S', preview: 'Could we discuss the insurance part?', time: 'Tue 04:15 PM', unreadCount: 0, unread: false, active: false, quoteNo: 'QT-8824', baseFreight: '€ 35,000', isVerified: false, isPinned: false },
        { id: 4, name: 'Express Cargo', avatar: 'E', preview: 'Your items have been picked up.', time: 'Mon 11:20 AM', unreadCount: 1, unread: true, active: false, quoteNo: 'QT-8825', baseFreight: '€ 38,000', isVerified: true, isPinned: false },
    ]);
    ...
    const [chatMessages, setChatMessages] = useState<Record<number, any[]>>({
        ...
        2: [
            ...
            { id: 2, type: 'received', sender: 'Fast Track BD', text: 'We can do it for 32,000 €.', time: 'Yesterday 04:30 PM', avatar: 'F' },
        ],
        3: [
            { id: 1, type: 'system', text: 'Negotiation started for Quote QT-8824', time: 'Tue 02:00 PM' },
            { id: 2, type: 'received', sender: 'Safe Logistics', text: 'Could we discuss the insurance part?', time: 'Tue 04:15 PM', avatar: 'S' },
        ],
        4: [
            { id: 1, type: 'system', text: 'Negotiation started for Quote QT-8825', time: 'Mon 09:00 AM' },
            { id: 2, type: 'received', sender: 'Express Cargo', text: 'Your items have been picked up.', time: 'Mon 11:20 AM', avatar: 'E' },
        ]
    });
                        ...
                        {filteredChats.map((chat) => {
                            ...
                            return (
                                <div
                                    ...
                                    className={`p-2.5 rounded-md cursor-pointer flex gap-3 items-center group relative transition-all mt-1 ${isActive ? 'bg-slate-100/80 border border-slate-200/80 shadow-2xs' : 'hover:bg-slate-50 border border-transparent'}`}
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className="flex items-center justify-between gap-1">
                                            ...
                                            {chat.unreadCount > 0 && (
                                                <span className="px-1.5 py-0.5 rounded-full bg-[#FF4A1F] text-white text-[10px] font-bold shrink-0">
                                                    {chat.unreadCount}
                                                </span>
                                            )}
                                        </div>
                            ...
                            return (
                                <div key={msg.id} className={`flex gap-2.5 ${isSent ? 'justify-end' : 'justify-start'} ${spacingClass} group relative`}>
                                    ...
                                    <div
                                        ...
                                        className={`max-w-[75%] sm:max-w-[65%] flex flex-col ${isSent ? 'items-end' : 'items-start'} relative group transition-all duration-500 ${isHighlighted ? 'ring-2 ring-[#FF4A1F] ring-offset-2 rounded-2xl scale-[1.02]' : ''
                                            }`}
                                    >
                                        {/* Floating Action Toolbar on Left for sent, Right for received */}
                                        {!isEditing && (
                                            <div className={`absolute top-1/2 -translate-y-1/2 flex items-center gap-0.5 bg-white border border-slate-200/90 rounded-full px-1.5 py-0.5 shadow-sm opacity-0 group-hover:opacity-100 transition-all duration-200 z-30 ${isSent ? 'right-full mr-2.5' : 'left-full ml-2.5'
                                                }`}>
                                                <button
                                                    type="button"
                                                    onClick={() => handleTogglePinMessage(msg.id)}
                                                    className={`p-1.5 rounded-full transition-colors cursor-pointer ${msg.isPinned
                                        ...
                                        <div className={`relative px-4 py-2 text-[14px] leading-relaxed whitespace-pre-wrap break-words ${borderRadiusClasses} ${isSent
                    ...
                    <div className="mt-2 flex flex-col">
                                ...
                                <div className="px-5 pb-3">
                                    <div className="space-y-3 text-[11.5px] border-l-2 border-slate-200 pl-3.5 ml-1 my-1">
                                        ...
                                        <div className="relative">
                                            ...
                                            <p className="font-bold text-amber-700">Shipper Counter (€ 42,500)</p>
                        ...
                        <div>
                            ...
                            >
                                ...
                                <ChevronDown size={16} className={`text-slate-400 group-hover:text-slate-600 transition-transform ${openSections.privacy ? 'rotate-180' : ''}`} />
                            </div>
