                ...
                {selectedFiles.map((file, idx) => (
                    ...
                    >
                        {file.type.startsWith('image/') ? (
                            <div
    className="w-8 h-8 rounded bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-700 flex items-center justify-center overflow-hidden shrink-0">
                                <img
