...
export const OrderPODModal: React.FC<OrderPODModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 bg-slate-900/30 backdrop-blur-2xs flex items-center justify-center p-4 z-50">
            <form onSubmit={onSubmit} className="bg-white dark:bg-[#1e2329] rounded-[5px] max-w-md w-full p-6 border border-slate-200 dark:border-slate-800 shadow-md space-y-4">
