...
export const OrderRouteAndPOD: React.FC<OrderRouteAndPODProps> = ({
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            ...
            <div className="lg:col-span-7 space-y-5">
                <div
    className="bg-white dark:bg-[#1e2329] border border-slate-200 dark:border-slate-800 rounded-lg p-5 space-y-4 shadow-2xs">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {/* Pickup Box */}
                        <div
    className="p-4 rounded-lg border border-slate-200 dark:border-slate-800 bg-slate-50/60 dark:bg-slate-800/40 space-y-2">
    ...
    className="bg-white dark:bg-[#1e2329] border border-slate-200 dark:border-slate-800 rounded-lg p-5 space-y-4 shadow-2xs">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs">
                        <div
    className="p-3 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-800 rounded-lg">
    ...
    className="p-3 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-800 rounded-lg">
            ...
            <div
    className="lg:col-span-5 bg-white dark:bg-[#1e2329] border border-slate-200 dark:border-slate-800 rounded-lg p-5 space-y-4 shadow-2xs">
                ...
                {podUploaded ? (
                    <div
    className="p-4 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-800 rounded-lg space-y-3">
                        ...
                        <div className="flex gap-2 pt-2 border-t border-slate-200 dark:border-slate-800">
                            <Button 
                                variant="outline" 
                                size="sm" 
                                className="flex-1 text-xs h-8 cursor-pointer rounded-[4px]"
                                onClick={() => {
                    ...
                    <div className="p-8 border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-lg text-center space-y-3">
                        ...
                        <Button 
                            variant="primary" 
                            size="sm" 
                            className="bg-[#ff4a1f] hover:bg-[#e03e15] text-white text-xs h-8 cursor-pointer rounded-[4px]"
                            onClick={onOpenUploadModal}
                        >
                            Upload POD Document
                        </Button>
