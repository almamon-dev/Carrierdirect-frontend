...
export default function BlackoutDates() {
    ...
    className="p-4 md:p-6 w-full mx-auto min-h-screen font-sans antialiased space-y-5 bg-[#f8fafc] dark:bg-[#12161c]">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-xl font-bold text-slate-900 dark:text-slate-100 tracking-tight mb-1">Blackout Dates & Holidays</h1>
                    <p className="text-xs text-slate-500 dark:text-slate-400 font-medium">
                        Set unavailable dates for fleet booking due to maintenance, holidays, or weather.
                    </p>
                </div>
            ...
            {showModal && (
                <div className="fixed inset-0 bg-slate-900/30 backdrop-blur-2xs flex items-center justify-center p-4 z-50">
                    <form onSubmit={handleAddBlackout} className="bg-white rounded-[5px] max-w-md w-full p-6 border border-slate-200 shadow-md space-y-4">
