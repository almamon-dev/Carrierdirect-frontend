...
export default function AvailabilitySchedule() {
    ...
    className="p-4 md:p-6 w-full mx-auto space-y-5 min-h-screen font-sans antialiased bg-[#f8fafc] dark:bg-[#12161c]">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div>
                    <h1 className="text-xl font-bold text-slate-900 dark:text-slate-100 tracking-tight mb-1">Availability Schedule</h1>
                    <p className="text-xs text-slate-500 dark:text-slate-400 font-medium">
                        Manage your regular and recurring working schedules.
                    </p>
                </div>
