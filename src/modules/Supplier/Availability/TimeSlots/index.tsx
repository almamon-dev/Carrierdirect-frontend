    ...
    return (
        <div className="p-4 md:p-6 w-full mx-auto min-h-screen">
            <div className="mb-6 flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div>
                    <h1 className="text-[18px] font-bold text-slate-900 mb-1">Time Slots</h1>
                    <p className="text-[12px] text-slate-500 font-medium">Configure standard operational windows for bookings.</p>
                </div>
