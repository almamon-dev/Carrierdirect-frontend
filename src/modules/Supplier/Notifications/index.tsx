/**
 * Supplier Notifications Main Page
 * Designed to strictly match the design standards of supplier/quotes/requests,
 * featuring dual Grid View and Table View, category filter tabs, status filters,
 * live synchronization with Header notifications, and rounded-[3px] aesthetics.
 */
...
import { getNotificationColumns } from './components/columns';
import { NotificationRowActions } from './components/NotificationRowActions';
import { FilterTabs, NotificationFilterTab } from './components/FilterTabs';
    ...
    return (
        <div className="p-4 md:p-6 w-full mx-auto space-y-5 min-h-screen font-sans antialiased bg-[#f8fafc] dark:bg-[#12161c]">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
                <div>
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400 font-medium">
                        Manage real-time alerts for quote requests, negotiation messages, order assignments, and payouts.
                    </p>
                </div>
            ...
            <DataTable
                ...
                searchPlaceholder="Search notifications by title, category, message..."
                compact={true}
                ...
                emptyState={
                    <EmptyState
                        ...
                        description={activeTab === 'all'
                            ? "You are completely up to date. New quote requests, messages, and order updates will appear here."
                            : `No notifications currently match the '${activeTab}' filter.`
                        }
                        actionLabel="Browse Quote Requests"
