...
import { Shield, Edit, Settings, Truck, Users, Package, Car, CreditCard, Headphones, Briefcase, Eye } from 'lucide-react';
...
export default function RolesTab() {
    ...
    return (
        <div className="space-y-4 min-h-[500px]">
            {/* Compact Role Cards Grid matching Dashboard summary card style */}
                ...
                {roles.map((role, idx) => {
                    ...
                    return (
                        <div 
                            ...
                            className="bg-white p-4 rounded-lg border border-slate-200 hover:border-slate-300 hover:bg-slate-50 transition-colors flex flex-col items-start cursor-pointer w-full shadow-sm"
                        >
