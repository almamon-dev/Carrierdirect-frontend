...
export const SubmittedSuccessView: React.FC<SubmittedSuccessViewProps> = ({
    ...
    return (
        <div className="p-4 md:p-6 w-full min-h-[80vh] flex items-center justify-center font-sans">
            <div
    className="bg-white dark:bg-[#1e2329] border border-slate-200 dark:border-slate-800 shadow-2xs rounded-lg p-6 max-w-md w-full text-center">
                <div className="w-11 h-11 bg-emerald-50 dark:bg-emerald-950/40 text-emerald-600 rounded-lg flex items-center justify-center mx-auto mb-3 border border-emerald-200 dark:border-emerald-800">
                ...
                <div
    className="bg-slate-50 dark:bg-[#181d24] border border-slate-200 dark:border-slate-800 rounded-lg p-3 mb-4 text-left space-y-2 text-xs text-slate-600 dark:text-slate-400">
...
export const DeclinedView: React.FC<DeclinedViewProps> = ({ requestDetails }) => {
    ...
    return (
        <div className="p-4 md:p-6 w-full min-h-[80vh] flex items-center justify-center font-sans">
            <div
    className="bg-white dark:bg-[#1e2329] border border-slate-200 dark:border-slate-800 shadow-2xs rounded-lg p-6 max-w-md w-full text-center">
                <div className="w-11 h-11 bg-slate-100 dark:bg-slate-800 text-slate-600 rounded-lg flex items-center justify-center mx-auto mb-3 border border-slate-200 dark:border-slate-700">
                    <XCircle size={24} />
                </div>
