...
export const RouteSkeletonCard: React.FC = () => {
    return (
        <div
    className="bg-white dark:bg-[#1e2329] border border-slate-200 dark:border-slate-800 rounded-lg p-3.5 sm:p-4 space-y-3.5 shadow-2xs">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between pb-3.5 border-b border-slate-100 dark:border-slate-800 gap-3">
                ...
                <div
    className="bg-slate-50 dark:bg-[#181d24] border border-slate-200/90 dark:border-slate-800 px-3 py-1.5 rounded-lg text-right space-y-1 min-w-[120px]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] gap-3 items-stretch">
                <div
    className="p-3 rounded-lg border border-slate-200/80 dark:border-slate-800 bg-slate-50/60 dark:bg-[#181d24]/60 flex flex-col justify-between space-y-2 min-h-[120px]">
                    <div className="space-y-1.5">
