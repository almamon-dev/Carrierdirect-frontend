...
interface CustomerProfileAccountTableProps {
    customerName: string;
    formattedId: string;
    customerRating?: number | string;
}

export const CustomerProfileAccountTable: React.FC<CustomerProfileAccountTableProps> = ({
    customerName,
    formattedId,
    customerRating = '4.9',
}) => (
    <div className="space-y-4 min-w-0">
        <div>
            <h4 className="text-xs font-semibold text-slate-700 dark:text-slate-200 mb-2 pb-1 border-b border-slate-100 dark:border-slate-800">
            ...
            <table className="w-full text-[11.5px] border-collapse">
                <tbody>
                    <tr className="border-b border-slate-100/80 dark:border-slate-800/80">
                        ...
                        <td className="py-2 pl-2 font-semibold text-slate-800 dark:text-slate-100 truncate">{customerName}</td>
                    </tr>
                    <tr className="border-b border-slate-100/80 dark:border-slate-800/80">
                        <td className="py-2 text-slate-500 dark:text-slate-400 font-medium whitespace-nowrap w-[130px]">
                    ...
                    <tr className="border-b border-slate-100/80 dark:border-slate-800/80">
                        ...
                        <td className="py-2 pl-2 font-semibold text-slate-800 dark:text-slate-100">
                            <span className="text-amber-500 font-bold">{customerRating}</span>{' '}
                    ...
                    <tr className="border-b border-slate-100/80 dark:border-slate-800/80">
                        ...
                        <td className="py-2 text-slate-400 font-bold text-center w-[24px] select-none">:</td>
                        <td className="py-2 pl-2 font-semibold text-slate-800 dark:text-slate-100">42+ <span className="text-[10px] font-semibold text-emerald-600 dark:text-emerald-400 ml-1">(100% Fulfilled)</span></td>
                    </tr>
                    <tr className="border-b border-slate-100/80 dark:border-slate-800/80">
                        <td className="py-2 text-slate-500 dark:text-slate-400 font-medium whitespace-nowrap w-[130px]">
                    ...
                    <tr className="border-b border-slate-100/80 dark:border-slate-800/80">
                        ...
                        <td className="py-2 text-slate-400 font-bold text-center w-[24px] select-none">:</td>
                        <td className="py-2 pl-2 font-medium text-slate-800 dark:text-slate-200 capitalize truncate">Verified Customer</td>
                    </tr>
                    <tr className="border-b border-slate-100/80 dark:border-slate-800/80">
                        <td className="py-2 text-slate-500 dark:text-slate-400 font-medium whitespace-nowrap w-[130px]">
