...
export const CustomerProfileFreightTable: React.FC<{ customer: any }> = ({ customer }) => (
            ...
            <table className="w-full text-[11.5px] border-collapse">
                <tbody>
                    <tr className="border-b border-slate-100/80 dark:border-slate-800/80">
                        ...
                        <td className="py-2 pl-2 font-semibold text-slate-800 dark:text-slate-100 leading-snug">
                            {customer.pickup && customer.delivery ? `${customer.pickup} → ${customer.delivery}` : customer.routeText || 'Berlin → Hamburg Hub'}
                        </td>
                    </tr>
                    <tr className="border-b border-slate-100/80 dark:border-slate-800/80">
                        <td className="py-2 text-slate-500 dark:text-slate-400 font-medium whitespace-nowrap w-[130px]">
                        ...
                        <td className="py-2 text-slate-400 font-bold text-center w-[24px] select-none">:</td>
                        <td className="py-2 pl-2 font-semibold text-slate-800 dark:text-slate-100">{customer.vehicleType || 'Covered Van (20ft)'}</td>
                    </tr>
                    <tr className="border-b border-slate-100/80 dark:border-slate-800/80">
                        <td className="py-2 text-slate-500 dark:text-slate-400 font-medium whitespace-nowrap w-[130px]">
                        ...
                        <td className="py-2 text-slate-400 font-bold text-center w-[24px] select-none">:</td>
                        <td className="py-2 pl-2 font-semibold text-slate-800 dark:text-slate-100">{customer.palletType || 'Palletized Commercial Freight'}</td>
                    </tr>
                    <tr className="border-b border-slate-100/80 dark:border-slate-800/80">
                        <td className="py-2 text-slate-500 dark:text-slate-400 font-medium whitespace-nowrap w-[130px]">
