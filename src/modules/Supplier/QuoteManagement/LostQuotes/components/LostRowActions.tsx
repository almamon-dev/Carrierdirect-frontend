/**
 * LostRowActions Component
 * 3-dot dropdown action menu for Lost Quotes using React Portal and rounded-[2px] button.
 */
...
interface LostRowActionsProps {
    row: LostQuoteItem;
}

export const LostRowActions: React.FC<LostRowActionsProps> = ({ row }) => {
        ...
        <div className="relative flex items-center justify-end w-full">
            ...
            {isOpen && createPortal(
                ...
                >
                    ...
                    >
                        <Search size={14} className="text-[#ff4a1f]" />
                        <span>Find Similar RFQs</span>
                    </button>
                </div>,
                document.body
            )}
