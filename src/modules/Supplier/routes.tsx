...
export const supplierRoutes: RouteObject[] = [
    ...
    { path: 'quotes', element: <Navigate to="/supplier/quotes/requests" replace /> },
    ...
    { path: 'orders', element: <Navigate to="/supplier/orders/active-jobs" replace /> },
    ...
    { path: 'availability', element: <Navigate to="/supplier/availability/dashboard" replace /> },
    ...
    { path: 'team/dashboard', element: <TeamManagement /> },
    { path: 'team/members', element: <TeamManagement /> },
    { path: 'team/roles', element: <TeamManagement /> },
    { path: 'team/invitations', element: <TeamManagement /> },
    { path: 'team/logs', element: <TeamManagement /> },
    { path: 'team/activity-logs', element: <TeamManagement /> },
    { path: 'team/trash', element: <TeamManagement /> },
    { path: 'team/trash-bin', element: <TeamManagement /> },
    { path: 'team/member/:id', element: <TeamMemberProfilePage /> },
    { path: 'team/members/:id', element: <TeamMemberProfilePage /> },
