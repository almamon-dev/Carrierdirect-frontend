...
interface InvoiceFilterContentProps {
    stageFilter: string;
...
export const InvoiceFilterContent: React.FC<InvoiceFilterContentProps> = ({
    stageFilter,
    setStageFilter,
    methodFilter,
    setMethodFilter,
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 pt-2 font-sans">
            <div>
                ...
                <Select
                    ...
                    options={[
                        ...
                        { id: "in_escrow", name: "Held in Escrow" },
                        { id: "due", name: "Due / Pay Later" },
                    ]}
                />
            </div>
            ...
            <div>
                ...
                <Select
                    ...
                    options={[
                        { id: "all", name: "All Terms & Methods" },
                        { id: "card", name: "Credit Card (Stripe)" },
                        { id: "pay_later", name: "Pay Later (30 Days Net)" },
